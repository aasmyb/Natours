...
var attachEventListener = function attachEventListener(elSelector, action, handler) {
  document.querySelector(elSelector).addEventListener(action, handler);
};

var getElement = function getElement(elSelector) {
...
if (getElement('.nav__el--logout')) {
  attachEventListener('.nav__el--logout', 'click', _login.logout);
}
